...
return [
    ...
    */
    ...
    'waits' => [
        'redis:default' => (int) env('HORIZON_QUEUE_WAIT_SECONDS', 60),
    ],
    ...
    */
    ...
    'defaults' => [
        'supervisor-1' => [
            'connection' => 'redis',
            'queue' => explode(',', (string) env('HORIZON_QUEUES', env('REDIS_QUEUE', 'default'))),
            'balance' => 'auto',
            ...
            'timeout' => (int) env('HORIZON_WORKER_TIMEOUT', 180),
            'nice' => 0,
        ],
    ],
