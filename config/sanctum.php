...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Mobile Token Expiration Days
    |--------------------------------------------------------------------------
    |
    | Tokens issued by the CRM mobile login endpoint expire independently from
    | Sanctum's global expiration. Set this to 0 to issue non-expiring tokens.
    |
    */
