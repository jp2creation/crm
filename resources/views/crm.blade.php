...
<html lang="fr">
  <head>
    ...
    <script type="module" crossorigin src="{{ asset('assets/index-CqSzWeas.js') }}?v=2026070913"></script>
    <script type="module" crossorigin src="{{ asset('assets/crm-conges.js') }}?v=2026071015"></script>
