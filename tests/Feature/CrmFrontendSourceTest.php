...
class CrmFrontendSourceTest extends TestCase
{
    public function test_crm_shell_is_loaded_from_versioned_vite_source(): void
    {
        ...
        $this->assertStringContainsString('private void openDeviceSecuritySettings()', $mainActivity);
        $this->assertStringContainsString('public void setAppCode()', $mainActivity);
        $this->assertStringContainsString('public void clearAppCode()', $mainActivity);
        $this->assertStringContainsString('public void openDeviceSecuritySettings()', $mainActivity);
        ...
        $this->assertStringContainsString('Sécurité de l’app', $androidSettingsOverride);
        ...
        $this->assertStringContainsString('nativeBridge.checkForUpdates()', $androidSettingsOverride);
        $this->assertStringContainsString('nativeBridge.setAppCode()', $androidSettingsOverride);
        $this->assertStringContainsString('nativeBridge.openDeviceSecuritySettings()', $androidSettingsOverride);
        ...
        $this->assertStringContainsString('versionCode 51', $androidBuild);
        $this->assertStringContainsString('versionName "1.49"', $androidBuild);
        ...
        $this->assertStringContainsString('crm-mobile-app-settings-quick-card', $mobileSettings);
        $this->assertStringContainsString('crm-mobile-app-settings-card', $mobileSettings);
        ...
        $this->assertStringContainsString('data-crm-mobile-fingerprint-status', $mobileSettings);
        $this->assertStringContainsString('data-crm-mobile-face-status', $mobileSettings);
        $this->assertStringContainsString('data-crm-mobile-device-code-status', $mobileSettings);
        $this->assertStringContainsString('data-crm-mobile-auth-summary', $mobileSettings);
        $this->assertStringContainsString('data-crm-mobile-app-code-detail', $mobileSettings);
        ...
        $this->assertStringContainsString('.crm-mobile-app-settings-quick-card', $shellCss);
        $this->assertStringContainsString('.crm-mobile-app-settings-card-heading', $shellCss);
        $this->assertStringContainsString('.crm-mobile-app-settings-pill', $shellCss);
        $this->assertStringContainsString('.crm-mobile-app-settings-methods', $shellCss);
