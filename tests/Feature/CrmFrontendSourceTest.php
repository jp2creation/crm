...
class CrmFrontendSourceTest extends TestCase
{
    public function test_crm_shell_is_loaded_from_versioned_vite_source(): void
    {
        ...
        $this->assertStringContainsString('versionCode 49', $androidBuild);
        $this->assertStringContainsString('versionName "1.47"', $androidBuild);
        ...
        $this->assertStringContainsString('crm-mobile-app-settings-hero', $mobileSettings);
        ...
        $this->assertStringContainsString('.crm-mobile-app-settings-hero', $shellCss);
        ...
        $this->assertStringContainsString('.crm-mobile-app-settings-feature-button', $shellCss);
        ...
        $this->assertStringContainsString('.crm-mobile-app-settings-status div > span:not(.crm-mobile-app-settings-card-icon)', $shellCss);
