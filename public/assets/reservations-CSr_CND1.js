import {
    ...
    u as d,
    w as f,
} from "./index-CqSzWeas.js?v=2026070806";
import { t as p } from "./dashboard-Chzs1W9w.js?v=2026070806";
import {
    a as m,
    i as h,
    n as ee,
    ...
    s as ne,
    t as re,
} from "./reservations-DvkqhioU.js?v=2026070806";
var _ = r(o(), 1),
...
@media (max-width:840px){
  ...
  .reservation-agenda-actions{display:grid;width:100%;grid-template-columns:repeat(4,minmax(0,1fr));gap:.35rem}
...
function V({
    ...
    return (0, S.jsx)(`div`, {
        className: `reservation-time-planner rounded-b-xl`,
        children: (0, S.jsxs)(`div`, {
            className: `reservation-time-grid`,
